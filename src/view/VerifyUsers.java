...
public class VerifyUsers extends javax.swing.JFrame {
    ...
    public void getAllRecords(String email)
    {
        ...
        dtm.setRowCount(0);
        ArrayList<User> list = UserControl.getAllRecords(email);
        Iterator<User> itr = list.iterator();
        while(itr.hasNext()){
            User user1Obj = itr.next();
            if(!user1Obj.getEmail().equals("admin@gmail.com"))
            {
                dtm.addRow(new Object[]{user1Obj.getId(),user1Obj.getName(),user1Obj.getEmail(),user1Obj.getMobileNumber(),user1Obj.getAddress(),user1Obj.getStatus()});
            }
        }
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1322, 11, 34, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Search:");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(445, 112, -1, -1));
        ...
        getContentPane().add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(515, 109, 299, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 150, 1346, 450));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(a==0)
        {
          UserControl.changeStatus(email,status);
            setVisible(false);
